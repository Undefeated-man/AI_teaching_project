# Generated by Django 3.1.7 on 2021-07-17 00:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('example', models.ManyToManyField(to='questionRecord.Example')),
                ('uerId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='questionRecord.commonuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commonUserID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='uerID', to='questionRecord.commonuser')),
            ],
            options={
