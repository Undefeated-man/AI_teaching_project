...
def welcome(request):
    ...
    lectureExcel_6 = pd.read_excel('/Lectures/Lecture 2.xlsx')
    lectureExcel_7 = pd.read_excel('/Lectures/Lecture 7.xlsx')
    lectureExcel_8 = pd.read_excel('/Lectures/Lecture 8.xlsx')
    lectureExcel_9 = pd.read_excel('/Lectures/Lecture 9.xlsx')
    lectureExcel_10 = pd.read_excel('/Lectures/Lecture 10.xlsx')
    lectureExcel_11 = pd.read_excel('/Lectures/Lecture 11.xlsx')
